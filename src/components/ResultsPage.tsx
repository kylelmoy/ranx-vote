        ...
        >
          ...
          <Column center fillWidth gap="s">
            ...
            {results.tie.map(t => {
              ...
              return <Badge key={candidate?.optionId} title={candidate?.name} arrow={false} paddingX="12" paddingY="8" />;
            })}
          </Column>
        </Column>
      }
          ...
          >
            ...
            <Column gap="s" fillWidth >
              {Array.from(round.voters.entries()).map(([candidateId, voters]) => {
                ...
                return (
                  <Row key={candidateId} align="center" gap="m" fillWidth style={{ justifyContent: "space-between" }}>
                    <Column align="left">
                      <Text variant="body-default-m" style={{ textDecoration: isEliminated ? 'line-through' : 'none' }}>
                    ...
                    >
                      <Column padding="20" gap="20" radius="l" maxWidth={24} background="page" border="neutral-alpha-weak">
                        <Row gap="8" wrap>
                          {voters.map(voterName => (<Tag key={voterName}>{voterName}</Tag>))}
                        </Row>
                      </Column>
                    </HoverCard>
